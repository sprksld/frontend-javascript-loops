...
for (let i = 0; i < 5; i++) {
    if (i == 4) console.log("klaar!"); else console.log("loop...");
}
...
for (let i = 0; i < 15; i++) {     // tot 15 interpreteer is als exclusief het getal 15; anders <= gebruiken
    if (i % 2) console.log(i + " is oneven"); else console.log(i + " is even");
}
